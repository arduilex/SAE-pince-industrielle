...
tof_lib = CDLL("../VL53L0X-python/bin/vl53l0x_python.so")
...
class CapteurTof(object):
    ...
    def __init__(self, address=0x29, TCA9548A_Num=255, TCA9548A_Addr=0, **kwargs):
        ...
        self.my_object_number = CapteurTof.object_number
        CapteurTof.object_number += 1

    def start_ranging(self, mode="beter"):
        """Start VL53L0X ToF Sensor Ranging"""
        # Ajout perso
        mode_list = ["good", "beter", "best", "long", "speed"]
    ...
    def get_distance(self):
        """Get distance from VL53L0X ToF Sensor in mm"""
    ...
    def get_timing(self):
        ...
        if (Status == 0):
            if budget.value + 1000 < 20000:
                return 0.02
            else:
                return (budget.value + 1000)/1000000.00
        else:
            return 0.02
